...
log_info "Creating bearer with APN=$CELLULAR_APN, IP-Type=$CELLULAR_IP_TYPE..."

if mmcli -m $MODEM_ID --create-bearer="apn=$CELLULAR_APN,ip-type=$CELLULAR_IP_TYPE" 2>&1; then
